...
(defcustom unrepl-start-socket-repl-expr
  "(do (require 'clojure.core.server) (let [srv (clojure.core.server/start-server {:name :repl :port 0 :accept 'clojure.core.server/repl})] (println (pr-st [:unrepl.el/server-ready (.getLocalPort srv)]))))"
